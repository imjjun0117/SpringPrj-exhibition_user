               ...
               <div class="container"> 
                    ...
                    <div id="navbar-scroll" class="collapse navbar-collapse navbar-backyard navbar-right">
                        <ul class="nav navbar-nav">
                            <li><a href="http://localhost/sist/user/list.do">전체 전시 보기</a></li>
                            <li><a href="http://localhost/sist/user/loc.do">지역별 전시 보기</a></li>
                            <li><a href="http://localhost/sist/user/reservation.do">예약으로 돌아가기</a></li>
                                    <li><a href="http://localhost/sist/user/board.jsp">게시판</a></li>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="row sign-in">
                        ...
                        <form action="my-account.jsp" method="post">
                            ...
                            <div class="text-center">
                              <a href="http://localhost/sist/user/index.do"><input type="button" id="find_direction" class="btn btn-warning btn-block btn-lg" value="메인으로 돌아가기"></a>  
                            </div>
                        </form>
