...
//	return "MyReservationVO [rez_date=" + rez_date + ", rez_status=" + rez_status + ", userid=" + userid
//			+ ", visit_date=" + visit_date + ", ex_name=" + ex_name + ", ex_hall_name=" + ex_hall_name + ", ex_num="
//			+ ex_num + ", rez_num=" + rez_num + ", rez_count=" + rez_count + ", rez_price=" + rez_price + ", rez_total="
//			+ rez_total + ", start_page=" + start_page + ", end_page=" + end_page + "]";
//}
//
//
//}
